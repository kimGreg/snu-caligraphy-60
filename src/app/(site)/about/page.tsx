  ...
  return (
    <section className="py-10 bg-gray-50">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center mb-1">서울대학교 서예회 </h1>
        <h1 className="text-4xl font-bold text-center mb-12">창립 60주년 기념전</h1>


        {/* 역사와 전통 섹션 */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-snublue mb-4">60년의 발자취</h2>
        ...
        {/* 목표와 가치관 섹션 */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-snublue mb-4">우리의 사명과 가치</h2>
          <p className="text-gray-900 leading-relaxed">
        ...
        {/* 주요 활동과 성과 섹션 */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-snublue mb-4">주요 활동과 성과</h2>
